...
* Pakistan Balochistan MICS 2019

global user "/Users/catherine.arsenault/Dropbox/BMGF RISP Project/Quant analysis/RAW DATA"

import spss using "$user/Pakistan/Pakistan (Balochistan) 2019-20 MICS6 Datasets/Pakistan (Baluchistan) SPSS Datasets/ch.sav", clear
...
* Penta3
	* By card
		...
		recode IM6PENTA3D 1/66=1 98/99=0, gen(penta3day)
	...
	* By recall	
		...
		recode IM21 1/2=0 3/7=1  8/9=0, g(penta3_recall) // number of penta doses
